      ...
      <div className="cart__item">
        <div className="item__dflex-left">
          ...
          <div className="dflex-left__content">
            ...
            <p onClick={() => this.handleRemoveClick(product)}>
              <i className="fas fa-trash-alt"></i> DELETE FROM CART
            </p>
          </div>
        </div>
        <div className="item__dfex-right">
          <div className="quantity_selector">
            <span
              onClick={() => this.handleMinusClick(product)}
              className="minus"
            >
            ...
            <span
              onClick={() => this.handlePlusClick(product.product)}
              className="plus"
            >
